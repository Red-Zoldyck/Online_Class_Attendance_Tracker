...
**Request Body** (Student or Instructor):
```json
{
...
```json
{
  ...
  "phone_number": "+1234567890",
  "role": 1,
  "admin_code": "@dm|n@2o2G!"
}
```

**Admin Code**: `@dm|n@2o2G!` (Required for admin registration)
...
| `absent` | A | Student did not attend the session |
| `late` | L | Student arrived after the start time |
| `excused` | E | Student was excused from attendance |
...
**Status Parameter**: Must be one of: `present`, `absent`, `late`, `excused`
